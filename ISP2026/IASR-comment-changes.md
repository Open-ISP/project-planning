...
The table shows the example output filename, the column that has changed - the current/existing output from the parser, the new/updated output from the fix (and the the original text to check / confirm the results)
